...
/** Größer-Operator für beliebig lange Zahlen
 * @param Ganzzahl
 * @param Ganzzahl
 * @return true gdw Erste ist echt größer als die zweite Zahl
 */ 
inline bool operator>(const BigInt& self, const BigInt& other) {
    return self.compare(other) > 0;
}
 ...
 * @param Ganzzahl
 * @param Ganzzahl
 * @return true gdw Erste ist größer gleich die zweite Zahl
 */ 
inline bool operator>=(const BigInt& self, const BigInt& other) {
    return self.compare(other) >= 0;
}
