...
__main  PROC
    ...
    ; R0 = UART_PortNum, R1 = U_DL , R2 = (UxFDR (7:4 MULVAL 3:0 DIVADDVAL) <<8) | UxLCR (UART_Mode), R3 = (INTE...
    ; 8 Nutzdatenbits pro Sendung, keine Parität, 1 Stopp Bit ; Interrupts ausgeschaltet
    ; FIFO aktiv, Trigger level = 1

    MOV R4,R0                  ; Copy of PortNum (weil R0..R3 Scratch-Register sind, d.h. in einer gerufenen Funktion ...
    BL  UART_init
    LDR R5, =MyString
